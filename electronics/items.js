...
window.ITEMS = [
 ...
 {id:"wacom-intuos-ctl490", cat:"part", zh:"Wacom Intuos Draw 数位板 (CTL-490)", en:"Wacom Intuos Draw Tablet (CTL-490)", price:30, photo:"",
  cond:"二手 · 含压感笔 / used — pen included", specs:["压感笔 1024 级 · 纯笔无触控 / pen only (1024 levels)","小尺寸 · 4 个快捷键 · USB 有线","2015 款 · 比 Bamboo 新 · 绘画/手写/osu!"],
  note:"海德公园自取 或 邮寄(买家付运费) / local or ship",
  detail:"Wacom Intuos Draw 数位板（CTL-490，黑色），含压感笔（LP-190K，1024 级压感）。纯笔款（不带触控），4 个快捷键，USB 有线，小巧便携。2015 款，比 Bamboo 略新；建议在 Windows 上装 Wacom 旧版驱动使用（较新的 macOS 已停止支持）。适合初学者绘画、手写笔记或 osu! 玩家。含笔，小巧可邮寄。Wacom Intuos Draw (CTL-490, black) — includes the pressure-sensitive pen (LP-190K, 1024 levels). Pen-only (no multi-touch), 4 ExpressKeys, corded USB, compact. 2015 model — a bit newer than the Bamboo; best on Windows with Wacom's legacy driver (support dropped on newer macOS). Great for beginners, handwriting/note-taking, or osu! players. Pen included; small, ships easily. Local pickup or ship at buyer's cost."},
