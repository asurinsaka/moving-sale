...
window.ITEMS = [
 ...
 {id:"skytech-chronos", cat:"desk", sold:true, zh:"Skytech Chronos 游戏主机", en:"Skytech Chronos Gaming PC", price:900, photo:"images/skytech.jpg",
  cond:"二手良好 · 顶部有轻微凹痕(仅外观) / used, good — minor cosmetic dent on top panel", specs:["Ryzen 7 3700X · RTX 3070 8G","16G DDR4-3600 · 256G SATA SSD","Windows 11"],
  note:"$900含4K显示器, 或 $650 只要主机 / $900 w/ 4K monitor, or $650 tower-only (+KB/mouse)",
  detail:"RTX 3070 游戏主机，2K 高画质流畅。顶部有一处轻微凹痕，纯外观、不影响使用。RTX 3070 rig — strong 1080p/1440p gaming. Small cosmetic dent on the top panel (does not affect performance).",
 ...
 {id:"ibuypower-w8700", cat:"desk", sold:true, zh:"iBUYPOWER 游戏主机 (整套)", en:"iBUYPOWER Gaming PC (complete setup)", price:340, photo:"images/ibuypower-w8700.jpg",
  cond:"已售出 / sold (2026-08)", specs:["i7-8700 (6核12线程) · GTX 970 4G","16G DDR4 · 120G SSD","ASUS H310 · Windows 11"],
 ...
 {id:"monitor-arm-dual", cat:"part", zh:"双屏显示器支架 (桌面夹式，可调)", en:"Dual Monitor Arm (desk clamp, VESA)", price:30, photo:"images/monitor-arm.jpg",
 ...
 {id:"amazon-notebook-arm-tray", cat:"part", zh:"Amazon Basics 笔记本支架托盘 (全新未拆封)", en:"Amazon Basics Notebook Laptop Stand Arm Mount Tray, Black (NEW/sealed)", price:15, photo:"images/amazon-notebook-arm-tray.jpg",
  ...
  detail:"Amazon Basics 笔记本托盘支架,夹在显示器支架杆上放笔记本(把显示器支架变成笔记本支架)。全新、原厂未拆封,新品约 $22–27。⚠️如实说明:外盒有点咖啡/水渍(仅外盒,里面密封未动)。海德公园自取或可邮寄(买家付运费)。可与我在卖的双屏支架一起要。Amazon Basics Notebook Arm Mount Tray — clamps onto a monitor arm to hold a laptop (turns a monitor arm into a laptop stand). Brand new, factory sealed (~$22-27 new). NOTE: the box has a cosmetic coffee/water stain, but it's sealed and the item inside is untouched. Local pickup in Hyde Park or ship at buyer's cost; pairs with the dual monitor arm I'm also selling."},
 {id:"razer-invicta", cat:"part", zh:"雷蛇 Razer Invicta 双面鼠标垫 (全新)", en:"Razer Invicta Mercury mouse mat (open-box)", price:50, photo:"images/razer-invicta.jpg",
 ...
 {id:"wacom-bamboo-cth470", cat:"part", zh:"Wacom Bamboo 数位板 (CTH-470)", en:"Wacom Bamboo Pen & Touch Tablet (CTH-470)", price:25, photo:"",
  cond:"二手良好 · 含压感笔 / used, good — pen included", specs:["压感笔 + 多点触控 / pen + multi-touch","小尺寸入门数位板 · USB","初学者 / 手写笔记 / osu! 玩家皆宜"],
  note:"海德公园自取 或 邮寄(买家付运费) / local or ship",
  detail:"Wacom Bamboo Pen & Touch 数位板（CTH-470），含压感笔，支持绘画/手写/触控手势。小巧入门款，适合初学者、手写笔记，或 osu! 玩家。较老型号，建议配较旧系统或安装 Wacom 旧版驱动。含笔，打包小巧可邮寄。Wacom Bamboo Pen & Touch tablet (CTH-470) — includes the pressure-sensitive pen; pen + multi-touch. Compact entry-level tablet: great for beginners, handwriting/note-taking, or osu! players. Older model — best on an older PC or with Wacom's legacy driver. Pen included; small, ships easily. Local pickup or ship at buyer's cost."},
 {id:"wacom-intuos-cth490", cat:"part", zh:"Wacom Intuos 数位板 (CTH-490 · 笔+触控)", en:"Wacom Intuos Art/Photo/Comic Tablet (CTH-490)", price:35, photo:"",
  cond:"二手 · 已测试可用 · 含压感笔 / used, tested working — pen included", specs:["压感笔 1024 级 + 多点触控 / pen (1024) + multi-touch","小尺寸 · 4 个快捷键 · USB 有线","2015 款 · 比 Bamboo 新 · 绘画/手写/osu!"],
  note:"海德公园自取 或 邮寄(买家付运费) / local or ship",
  detail:"Wacom Intuos 数位板（CTH-490，黑色，Art/Photo/Comic 笔+触控款），含压感笔（1024 级压感）+ 多点触控，已测试可用。4 个快捷键，USB 有线，小巧便携。2015 款，比 Bamboo 新。建议在 Windows 上装 Wacom 旧版驱动（较新的 macOS 已停止支持）；Linux 上免驱即插即用。适合绘画、手写笔记或 osu! 玩家。含笔，小巧可邮寄。Wacom Intuos (CTH-490, black — the Art/Photo/Comic pen + touch model) — pressure-sensitive pen (1024 levels) + multi-touch, tested working. 4 ExpressKeys, corded USB, compact. 2015 model, newer than the Bamboo. Best on Windows with Wacom's legacy driver (support dropped on newer macOS); plug-and-play on Linux. Great for drawing, handwriting/note-taking, or osu! players. Pen included; small, ships easily. Local pickup or ship at buyer's cost."},
